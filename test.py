...
class MyTest(unittest.TestCase):
	...
	def test_1_correct_magic_open_port_22(self):
		...
		self.assertEqual(msg, "The magic number is correct! -> The port opened successfully.")

	def test_2_correct_magic_not_open_port(self):
		msg = client.main('', 53, 0xDEADBEEF, 22, "")
		self.assertEqual(msg, "The magic number is correct! -> Didn't open a new port.")
	...
	def test_4_wrong_magic(self):
		...
		self.assertEqual(msg, "Wrong magic number!")
